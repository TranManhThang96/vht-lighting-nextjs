  ...
  return (
    <main className='min-h-screen'>
      ...
      <section className="relative min-h-[700px] bg-gradient-to-b from-blue-100 to-[#f7f7f7] before:absolute before:left-0 before:right-0 before:top-[-134px] before:h-[134px] before:bg-decorate before:bg-[length:100%_134px] before:bg-left-top before:bg-no-repeat before:content-['']">
        <div className='mx-auto w-full xl:max-w-screen-xl 2xl:max-w-screen-2xl'>
          <h3 className='mt-10 text-center text-base font-semibold uppercase text-blue-200'>Bộ sưu tập</h3>
          <h2 className='mt-4 text-center text-[42px] font-semibold leading-[50px] text-gray-100'>
            Tổng hợp các hình ảnh thực tế <br /> khách hàng nâng cấp đèn tại VHT Lighting
          </h2>
        </div>
      </section>
      ...
      <section className='min-h-[900px]'>
        <div className='mx-auto w-full py-10 xl:max-w-screen-xl 2xl:max-w-screen-2xl'>
          <h3 className='mt-10 text-center text-base font-semibold uppercase text-blue-200'>Sản phẩm</h3>
          <h2 className='mt-4 text-center text-[42px] font-semibold leading-[50px] text-gray-100'>
            Cùng khám phá các sản phẩm <br />
            vô cùng chất lượng mà VHT Lighting cung cấp
          </h2>
        </div>
      </section>
